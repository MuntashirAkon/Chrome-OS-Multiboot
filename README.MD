...
**Note:** **cros_update.sh** automatically downloads the necessary files (almost 2 GB in size, so have patience!) and can download the stable recovery updates only.
